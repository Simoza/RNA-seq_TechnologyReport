...
# Introduction
This advanced technology report describes a limma-based procedure to analyze RNA sequencing data and extract gene-level statistics to perform gene set analysis using the PIANO (<b>P</b>latform for <b>i</b>ntegrative <b>an</b>alysis of <b>o</b>mics data) approach. After a general introduction on RNA-sequencing principles and gene set analysis, the code used to perform the analysis will be described step by step. The procedure is based on <i<Y. lipolitica</i> but can be easily adjusted to different organisms as well. All the code is available on github at the following directory: <b> INSERT DIRECTORY HERE </b>. 
